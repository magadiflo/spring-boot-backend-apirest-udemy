...
public class UploadFileServiceImpl implements IUploadFileService {
	...
	public String copiar(MultipartFile archivo) throws IOException {
		String nombreArchivo = this.getNombreUnico(archivo.getOriginalFilename());
